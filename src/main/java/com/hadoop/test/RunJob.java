...
public class RunJob {
	...
	public static void main(String[] args) {
		...
		try
		{
			...
			//输入输出文件路径
			FileInputFormat.addInputPath(job, new Path("/home/pb/study/workspace/demo/output/"));
			FileOutputFormat.setOutputPath(job, new Path("/home/pb/study/workspace/demo/input/"));
